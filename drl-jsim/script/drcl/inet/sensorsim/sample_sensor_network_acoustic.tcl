...
mkdir drcl.inet.sensorsim.AcousticChannel chan 
...
mkdir drcl.inet.sensorsim.AcousticProp acoustic_Prop 
! acoustic_Prop setD0 0.2
...
for {set i [expr $sink_id + 1]} {$i < [expr $node_num - $target_node_num]} {incr i} {
	...
	connect phy/.propagation@ -and /aodvtest/acoustic_Prop/.query@
