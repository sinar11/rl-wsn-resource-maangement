 ...
 * It essentially contains 4 pieces of information:
 * Who sent it, the senders location (i.e. its coordinates), a timestamp to keep
 * track of latency, and the latest data sensed (i.e the phenomenon the sensors
 * are sensing).
 *
*/

public class OH_Packet extends Packet {
    ...
    public OH_Packet(long sid, double[] s_pos, double timeStamp_, int size_, Object phenomenon_)
    {
        sender_id = sid;
	...
	public Object clone()
	{
		return new OH_Packet(this.sender_id,this.sender_pos, this.timeStamp, size, body);
	}
}
