...
! n5/mobility setPosition 5.0 100.0  500.0 0.0
...
! n1/mobility setPosition 0.0 225.0 225.0 0.0
! n1/app setDestId 0
! n4/mobility setPosition 0.0 275.0 225.0 0.0
! n4/app setDestId 0
...
script {run n4} -at 0.5 -on $sim
script {run n5} -at 0.8 -on $sim

script {! n5/mobility setPosition 0.0 100.0  475.0 0.0} -at 10.0 -on $sim
script {! n5/mobility setPosition 0.0 150.0  500.0 0.0} -at 1000.0 -on $sim
script {! n5/mobility setPosition 0.0 200.0  550.0 0.0} -at 2000.0 -on $sim
script {! n5/mobility setPosition 0.0 250.0  575.0 0.0} -at 3000.0 -on $sim
script {! n5/mobility setPosition 0.0 300.0  550.0 0.0} -at 4000.0 -on $sim
script {! n5/mobility setPosition 0.0 350.0  500.0 0.0} -at 5000.0 -on $sim
script {! n5/mobility setPosition 0.0 400.0  475.0 0.0} -at 6000.0 -on $sim
