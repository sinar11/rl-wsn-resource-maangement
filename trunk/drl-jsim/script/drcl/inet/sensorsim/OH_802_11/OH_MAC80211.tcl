...
for {set i [expr $sink_id + 1]} {$i < [expr $node_num - $target_node_num]} {incr i} {
	...
	connect phy/.propagation@ -and /oneHop80211/seismic_Prop/.query@
...
for {set i [expr $sink_id + 1]} {$i < $node_num} {incr i} {
	...
	connect n$i/mobility/.report_sensor@ -and /oneHop80211/nodetracker/.node@
...
#-------------------------
#for validation ... do not use o.w.
#script [! n1/app setSendTime 9.8]
