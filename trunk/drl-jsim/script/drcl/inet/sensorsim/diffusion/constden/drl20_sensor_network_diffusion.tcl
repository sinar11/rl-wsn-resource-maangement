...
if { $target_node_num == 0 } {
	...
	for {set i [expr $node_num - $target_node_num]} {$i < $node_num} {incr i} {
		...
		! mobility setTopologyParameters 700.0 600.0 0.0 100.0 100.0 0.0
...
! n0/mobility setPosition 0.0 650.0 500.0 0.0
...
! n19/mobility setPosition 0.0 351.0 370.0 0.0
...
! n11/mobility setPosition 0.0 500.0 300.0 0.0
! n12/mobility setPosition 0.0 500.0 350.0 0.0
! n13/mobility setPosition 0.0 550.0 500.0 0.0
! n14/mobility setPosition 0.0 600.0 550.0 0.0
! n15/mobility setPosition 0.0 550.0 450.0 0.0
! n16/mobility setPosition 0.0 600.0 450.0 0.0
! n17/mobility setPosition 0.0 550.0 400.0 0.0
! n18/mobility setPosition 0.0 400.0 400.0 0.0
...
script {! n0/app subscribe 10 100.0 400.0 300.0 500.0 200000.0 53.0 5.0 2500.0 10} -at 3.0 -on $sim

set np 7; # number of points
set t [java::new {double[][]} $np]
$t set 0 [java::new {double[]} 4 "0 100.0 300.0 0"]
$t set 1 [java::new {double[]} 4 "2000 150.0 350.0 0"]
$t set 2 [java::new {double[]} 4 "4000 200.0 400.0 0"]
$t set 3 [java::new {double[]} 4 "6000 250.0 450.0 0"]
$t set 4 [java::new {double[]} 4 "8000 300.0 500.0 0"]
$t set 5 [java::new {double[]} 4 "10000 350.0 450.0 0"]
$t set 6 [java::new {double[]} 4 "12000 400.0 400.0 0"]
